...
// Renderizar dentro de <svg width=... height=... viewBox="0 0 24 24" stroke="currentColor"
// strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" fill="none">
// Estilo coincide con los iconos del Sidebar.
export const SVG_PATHS_ALERTAS = {
  // DollarSign (facturas vencidas)
  facturas_vencidas:
    '<line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/>',
  // Clock (actividades retrasadas)
  actividades_retrasadas:
    '<circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/>',
  // Lock (actividades bloqueadas)
  actividades_bloqueadas:
    '<rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/>',
  // Target (proyectos cierre próximo)
  proyectos_cierre_proximo:
    '<circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/>',
  // CreditCard (CxP)
  cxp_autorizacion_pendiente:
    '<rect x="2" y="4" width="20" height="16" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/>',
  // User+X (leads sin actividad)
  leads_sin_actividad:
  ...
  // FileText (cotizaciones sin respuesta)
  cotizaciones_sin_respuesta:
